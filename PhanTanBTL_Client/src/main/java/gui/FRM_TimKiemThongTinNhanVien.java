...
public class FRM_TimKiemThongTinNhanVien extends JPanel implements ActionListener {
	...
	public FRM_TimKiemThongTinNhanVien() {
		try {
			...
			String[] col = { "Mã Nhân Viên ", "Họ tên Nhân Viên", "Giới tính", "Ngày sinh", "CMND", "SDT", "Địa Chỉ",
	...
	public void updateTableDataNhanVien() throws RemoteException {
		...
		for (int i = 0; i < listnv.size(); i++) {
			...
			String[] rowData = { nv.getMaCongNhanVien(), nv.getHoTen(), gioiTinh, ngaySinh, nv.getMaCanCuocCongDan(),
					nv.getSoDienThoai(), nv.getDiaChi(), nv.getPhongBan().getTenPhongBan(), trangThai };

...
public class FRM_ChiTietBangThoLamDan extends JFrame {
	...
	private static DAO_ChamCongThoLamDan dao_ChamCongThoLamDan = new DAO_ChamCongThoLamDan();
	private static DAO_LuongThoLamDan dao_LuongThoLamDan = new DAO_LuongThoLamDan();
	private static DAO_Dan dao_Dan = new DAO_Dan();
...
//	}
	...
	public FRM_ChiTietBangThoLamDan(BangLuongThoLamDan bangLuongThoLamDan) {
		...
		double luong = dao_LuongThoLamDan.layTongThuNhapTungThang(bangLuongThoLamDan.getThoLamDan().getMaCongNhanVien(),

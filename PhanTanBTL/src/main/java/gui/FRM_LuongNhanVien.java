			...
			public void actionPerformed(ActionEvent e) {
				...
				for (NhanVien nhanVien : dao_NhanVien.getAllListNhanVien()) {
					soNgayThuongDiLam = (float) (dao_LuongNhanVien
							...
							+ 0.5 * dao_LuongNhanVien.laySoNgayDiLamNuaCaNgayThuong(nhanVien.getMaCongNhanVien(), thang,
									nam));
					soGioTangCaNgayThuong = dao_LuongNhanVien.laySoGioTangCaNgayThuong(nhanVien.getMaCongNhanVien(),
							thang, nam);
					soNgayLamChuNhat = (float) (dao_LuongNhanVien.laySoNgayDiLamNguyenCaCN(nhanVien.getMaCongNhanVien(),
							thang, nam) * 1.0
					...
					soNgayNghiKhongPhep = dao_LuongNhanVien.laySoNgayNghiKhongPhep(nhanVien.getMaCongNhanVien(), thang,
							nam);

...
public class FRM_ChamCongNhanVien extends JPanel {
	...
	private DAO_ChamCongNhanVien dao_ChamCongNhanVien;
	private DAO_LuongNhanVien dao_LuongNhanVien;
	...
	public FRM_ChamCongNhanVien() {
		try {
			...
			dao_ChamCongNhanVien = new DAO_ChamCongNhanVien();
			dao_LuongNhanVien = new DAO_LuongNhanVien();

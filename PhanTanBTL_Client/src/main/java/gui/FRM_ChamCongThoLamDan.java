...
public class FRM_ChamCongThoLamDan extends JPanel implements ActionListener {
	...
	private I_DAO_ChamCongThoLamDan dao_ChamCongThoLamDan;
	private I_DAO_ThoLamDan dao_ThoLamDan;
	private I_DAO_CongDoan dao_congDoan;
	private I_DAO_LuongThoLamDan dao_LuongThoLamDan;
	private I_DAO_Dan dao_dan;
	private I_DAO_BangPhanCong dao_BangPhanCong;
	...
	public FRM_ChamCongThoLamDan() {
		try {
			...
			dao_ThoLamDan = (I_DAO_ThoLamDan) Naming.lookup(URL + "I_DAO_ThoLamDan");
			...
			dao_BangPhanCong = (I_DAO_BangPhanCong) Naming.lookup(URL + "I_DAO_BangPhanCong");
